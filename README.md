...
Mỗi khi push lên nhánh `main` hoặc tạo Pull Request → tự động chạy:

1. ✅ Checkout code
2. ✅ Setup Java 17
3. ✅ Chạy `mvn test` (dùng H2, không cần PostgreSQL)
4. ✅ Build JAR

> File: `.github/workflows/ci.yml` — hoạt động ngay khi push lên GitHub, không cần config thêm gì.
...
| CI/CD deploy tự động | GitHub Actions + Docker Hub |
